...
이를 이 라이브러리에 대입해볼 수 있습니다. 여러분이 웹툰의 파일 저장본을 갖거나 만드는 것('복제')은 법적으로 허용됩니다. 하지만 이를 *공유*하는 경우 저작권자에게 피해가 가기에 상황에 따라 저작권을 위배하는 행동이 될 수 있습니다.
...
또한 만약 자신이 한국 국민이 아니라면 법 조항의 대상이 되지 않을 수 있습니다만 미국을 비롯한 대부분의 나라에서는 [베른 협약](https://ko.wikipedia.org/wiki/%EB%B2%A0%EB%A5%B8_%ED%98%91%EC%95%BD)을 맺고 있어 법 조항은 대동소이합니다.
