...
## 시작하기
1. 파이썬 3.11(혹은 3.10(호환)이나 3.12(추천하지 않음))을 설치합니다. [구글 검색](https://www.google.com/search?q=파이썬+설치).
...
> [!WARNING]
> Python 3.12에서 Treading 관련 변화로 인해 속도가 느려지고 CPU 점유율이 비정상적으로 높아지는 문제가 있습니다.
> 사용이 불가능한 것은 아니지만 Python 3.11을 사용하는 것을 권장합니다.
